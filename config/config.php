...
// Mail Configuration - Using environment variables from Render
define('MAIL_HOST', getenv('MAIL_HOST') ?: 'mail.privateemail.com');
define('MAIL_PORT', getenv('MAIL_PORT') ?: 587);
define('MAIL_USERNAME', getenv('MAIL_USERNAME') ?: 'info@raysofgrace.ac.ug');
define('MAIL_PASSWORD', getenv('MAIL_PASSWORD') ?: '');
define('MAIL_ENCRYPTION', getenv('MAIL_ENCRYPTION') ?: 'tls');
define('MAIL_FROM_ADDRESS', getenv('MAIL_FROM_ADDRESS') ?: 'info@raysofgrace.ac.ug');
define('MAIL_FROM_NAME', getenv('MAIL_FROM_NAME') ?: 'ROGELE');
