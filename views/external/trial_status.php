...
<div style="padding: 40px 20px; max-width: 800px; margin: 0 auto;">
    <div style="background: white; border-radius: 30px; padding: 40px; box-shadow: 0 20px 50px rgba(0,0,0,0.1);">
        <h1 style="font-size: 2rem; margin-bottom: 20px; background-color: #f06724; -webkit-background-clip: text; -webkit-text-fill-color: transparent; text-align: center;">
            Free Trial Status
        </h1>
        ...
        <?php if ($trial): ?>
            ...
            <div style="text-align: center; margin-bottom: 40px;">
                <div style="width: 150px; height: 150px; margin: 0 auto 20px; background-color: #f06724; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div style="width: 100%; height: 20px; background: #E2E8F0; border-radius: 10px; overflow: hidden;">
                    <div style="width: <?php echo $percentageUsed; ?>%; height: 100%; background-color: #f06724;"></div>
                </div>
        ...
        <?php else: ?>
            <div style="text-align: center;">
                ...
                <a href="<?php echo BASE_URL; ?>/external/subscription" style="display: inline-block; background-color: #f06724; color: white; text-decoration: none; padding: 15px 40px; border-radius: 50px; font-weight: 600;">
