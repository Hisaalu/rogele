...
$pageTitle = 'Trial Status - Rays of Grace';
...
<div style="padding: 40px 20px; max-width: 800px; margin: 0 auto;">
    <div style="background: white; border-radius: 30px; padding: 40px; box-shadow: 0 20px 50px rgba(0,0,0,0.1);">
        <h1 style="font-size: 2rem; margin-bottom: 20px; background: linear-gradient(135deg, #8B5CF6, #F97316); -webkit-background-clip: text; -webkit-text-fill-color: transparent; text-align: center;">
            Free Trial Status
        </h1>
        ...
        <?php if ($trial): ?>
            ...
            <div style="text-align: center; margin-bottom: 40px;">
                <div style="width: 150px; height: 150px; margin: 0 auto 20px; background: linear-gradient(135deg, #8B5CF6, #F97316); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                    <i class="fas fa-gift" style="font-size: 4rem; color: white;"></i>
                </div>
                <h2 style="color: #1E293B; margin-bottom: 10px;">You're on Free Trial</h2>
                <p style="color: #64748B;">Enjoying full access to all features</p>
            </div>
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div style="width: 100%; height: 20px; background: #E2E8F0; border-radius: 10px; overflow: hidden;">
                    <div style="width: <?php echo $percentageUsed; ?>%; height: 100%; background: linear-gradient(90deg, #8B5CF6, #F97316);"></div>
                </div>
            ...
            <?php if ($daysLeft <= 7): ?>
                <div style="background: #FEF2F2; border: 1px solid #FECACA; border-radius: 15px; padding: 20px; margin-bottom: 30px;">
                    <div style="display: flex; align-items: center; gap: 15px;">
                        <i class="fas fa-exclamation-triangle" style="color: #F97316; font-size: 2rem;"></i>
                        <div>
                            <h3 style="color: #B91C1C; margin-bottom: 5px;">Your trial is ending soon!</h3>
                            <p style="color: #64748B;">Subscribe now to continue uninterrupted access to all learning materials.</p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
